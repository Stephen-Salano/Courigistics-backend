...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    private void authenticateRequest(String token, @NonNull HttpServletRequest request, @NonNull HttpServletResponse response) throws IOException {
        ...
        if (validateRequest(token, userDetails, response)){
     ...
     */
    private boolean validateRequest(String token, UserDetails userDetails, @NonNull HttpServletResponse response) throws IOException {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request){
        ...
        return path.startsWith("/api/v1/auth/register")
                ...
                || path.startsWith("/api/v1/auth/setup-account")
                || path.startsWith("/h2-console")
